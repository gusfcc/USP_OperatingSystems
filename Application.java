...
public class Application {
    ...
    public static void main(String args[]){
        ...
        loop:while(true){
            ...
            System.out.println("7 - Mostrar tabela de páginas de um processo");
            System.out.println("8 - Mostrar endereço físico de um processo a partir do lógico");
            ...
            switch(uInput) {
                ...
                case "6":
                    try {
                        System.out.println("Bitmap dos processos: ");
    ...
    private static int chooseBlockSize(){
        ...
        int frames = 0;
        while(true){
            System.out.println("Por favor, insira a quantidade de quadros do sistema simulado (Digitar apenas 32,64 ou 128).");
            frames = sc.nextInt();
            switch(frames) {
                case 32, 64, 128:
